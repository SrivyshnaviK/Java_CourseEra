package com.Vyshnavi.BabyNames.BabyBirthsAssignments;
...
public class BabyBirthsAssignment {
    ...
    public int getRank(int year,String name,String gender){
        FileResource fileResource=new FileResource("src/com/Vyshnavi/BabyNames/data/yob"+year+".csv");
        int rank=0;
    ...
    public static void main(String[] args) {
        ...
        FileResource fileResource=new FileResource("src/com/Vyshnavi/BabyNames/data/yob1900.csv");
